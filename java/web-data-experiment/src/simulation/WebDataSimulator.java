...
public class WebDataSimulator {
	...
	public WebDataSimulator(int chunk_size,int proxyCacheSize,int mobileCacheSize, String datapath){
	...
	public void setOutputFile(){
		try {
			out = new PrintWriter(datapath + "output.txt");
