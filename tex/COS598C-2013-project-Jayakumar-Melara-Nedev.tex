...
%As a result, the amount of mobile Web traffic now takes a serious portion of the total amount of Internet traffic. Moreover, it is expected to grow exponentially with every subsequent year. These facts put new challenges in the ways mobile networks are designed and built. New methods alleviation of the amount of transmitted mobile web traffic data should be found. 
