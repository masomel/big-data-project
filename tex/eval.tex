...
This is innately tied to the size of the content. Figure __ shows the relationship between \% of web content that is needed (based on cache miss rate) and chunk size based on a series of visits to cnn.com. 
...
We assume that during each request
